...
export const {resetDonations, updateSelectedDonationId, getDonate} =
  Donations.actions;
export default Donations.reducer;

// export const selectDonate = (state,id) => state.donationReducer.byId[id];

// export const selectDonates = (state)=>{
//   let arr = []
//   state.donations.allId.forEach(id)=>{
//   const donate =  state.donationReducer.byId[id]
//     if(donate) {
//       arr.push(donate)
//     }
